/**
 * Three roles per PRD §5 / ARCHITECTURE.md §4. An absent or unrecognized
 * role resolves to null (access denied), never to "viewer" — there is no
 * default role for a new account.
 */
export type Role = "viewer" | "staff" | "admin";
const VALID_ROLES: readonly Role[] = ["viewer", "staff", "admin"];
