...
describe("live database verification (PGlite)", () => {
  ...
  it("has no DROP/HOLD column in any table's live schema", async () => {
  ...
  it("keeps identity fields out of the registrants table", async () => {
    ...
    expect(registrantColumns).not.toContain("address_line1");
  });
